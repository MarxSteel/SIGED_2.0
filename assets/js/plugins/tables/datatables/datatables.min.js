...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Clicar para ordenar como crescente",
sSortDescending:": Clicar para ordenar como decrescente"},oPaginate:{sFirst:"Primeiro",sLast:"Ultimo",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem informações para mostrar",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando 0 de 0 resultados 0",sInfoFiltered:"(filtrado de _MAX_ resultados totais)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"mostrar _MENU_ resultados",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum resultado para o filtro"},
