...
$mail->Username = 'sistema@interactbrasil.org'; // Usuário do servidor SMTP (endereço de email)
$mail->Password = '123456'; // Mesma senha da sua conta de email
...
$mail->AddAddress('analista.marx@gmail.com', 'Marx Medeiros');
        ...
        <td class="container">
          <div class="content">
            <table class="main">
              ...
              <tr>
                <td class="wrapper">
                 <img src="http://interactbrasil.org/emailbg.png" width="500">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center">
                       <h3> Você foi cadastrado no Portal SIGED!
                        Seguem Dados:
                        </h3>
                        <h4>
                         <strong>Login: </strong><i>analista.marx@gmail.com</i><br />
                         <strong>Senha: </strong><i><code>ABx281K82Z</code></i>
                        </h4>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://interactbrasil.org/sistema" target="_blank">Acessar o Sistema</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
